...
\item\textbf{Q: If I annotate the whole sentence as a sentiment,
  should I also include the hyperlinks at the end of the sentence in
  that markable?}

\item\textbf{Q: If sentiment is expressed by the whole sentence,
  should I also include the @-mentions and retweets at the beginning
  of the tweet in that tags?}
