...
\item\textbf{Q: Should I consider as sentiments irrealis
  ...
  then you should mark the whole wish as a \texttt{sentiment},
  annotate the wished property as a \texttt{target}, and set the
  \texttt{polarity} value of that \texttt{sentiment} markable to
...
\item\textbf{Q: Should I consider as a sentiment the wish to get
  somenting?}
